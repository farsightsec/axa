 ...
 *  \param[] out_nmsg_output nmsg_output_t of the newly opened nmsg connection
 ...
 *
 *  \return -1 on error, 0 on bad host/port/filename, 1 on success and 
 *  out_nmsg_output/out_sock_type will be set
 */
